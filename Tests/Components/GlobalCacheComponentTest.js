...
import GlobalCacheComponent from '../../App/Components/GlobalCacheComponent'

const wrapper = shallow(<GlobalCacheComponent />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('GlobalCacheComponent Component')) // That the Component Text is included
})
