...
import RoomButton from '../../App/Components/RoomButton'

const wrapper = shallow(<RoomButton />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('RoomButton Component')) // That the Component Text is included
})
