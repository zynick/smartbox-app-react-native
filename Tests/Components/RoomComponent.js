...
import RoomComponent from '../../App/Components/RoomComponent'
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('RoomComponent Component')) // That the Component Text is included
})
