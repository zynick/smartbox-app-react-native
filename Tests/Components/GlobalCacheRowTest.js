...
import GlobalCacheRow from '../../App/Components/GlobalCacheRow'

const wrapper = shallow(<GlobalCacheRow />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('GlobalCacheRow Component')) // That the Component Text is included
})
